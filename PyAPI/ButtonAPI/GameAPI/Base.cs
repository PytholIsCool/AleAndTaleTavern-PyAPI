...
namespace ButtonAPI.GameAPI {
    public class GameAPIBase {
        ...
        public static Transform PanelButtonTemplate, TabTemplate, SelectorTemplate, SliderTemplate, ToggleTemplate;
        public static bool IsReady() {
            if (SceneManager.GetActiveScene().name != "Playtest")
                return false;

            if ((GameMenu = Object.FindObjectOfType<GameMenu>().transform) == null) MelonLogger.Msg("PyAPI Fatal Error: \"GameMenu\" reference is null \nClass: GameAPIBase");
            ...
            if ((TabTemplate = Settings?.Find("BG/Tab_Panel/Button Game")) == null) MelonLogger.Msg("PyAPI Error: \"TabTemplate\" reference is null \nClass: GameAPIBase");
